    ...
    context("Self-Destructs") {
      ...
      context("with SelfDestructDelegatingCalls contract") {
        ...
        test("should send ether to contract after self referencing destroy") {
          ...
          val block =
            testHelper.blocksFor(SelfDestructDelegatingCalls.shouldSendEtherToContractAfterSelfReferencingDestroy)
              .first()
        ...
        test("should produce a cascading destroy and refund sender") {
          ...
          val block =
            testHelper.blocksFor(SelfDestructDelegatingCalls.shouldProduceACascadingDestroyAndRefundSender).first()
        ...
        test("should create self destroying contracts and self destruct itself") {
          ...
          val block =
            testHelper.blocksFor(SelfDestructDelegatingCalls.shouldCreateSelfDestroyingContractsAndSelfDestructItself)
              .first()
